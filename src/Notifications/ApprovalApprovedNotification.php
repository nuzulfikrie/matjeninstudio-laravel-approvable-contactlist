...
class ApprovalApprovedNotification extends Notification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Approval Approved: '.class_basename($approvable))
            ->line('Your approval request has been approved.')
            ->line('Approved by: '.$user->name)
    ...
    public function toArray($notifiable): array
    {
        ...
        return [
            ...
            'message' => 'Your approval request for '.class_basename($approvable).' has been approved.',
